...
for($i=0; $i<100; $i++){
    ...
    $results[$i]['islamiat'] = $dom->getElementsByTagName('td')->item(38)->nodeValue;
    $results[$i]['pakistan-studies'] = $dom->getElementsByTagName('td')->item(42)->nodeValue;
    ...
    $results[$i]['bio-1'] = $dom->getElementsByTagName('td')->item(62)->nodeValue;
    $results[$i]['bio-2'] = $dom->getElementsByTagName('td')->item(66)->nodeValue;
